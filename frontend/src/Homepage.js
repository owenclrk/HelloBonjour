...
const Homepage = () => {
  ...
  const handleDelete = async (id) => {
    try {
      await api.delete(`/translations/${id}`); // Ensure your FastAPI route is @app.delete("/translations/{item_id}")
  ...
  return (
    ...
    <div className="app-container">
      ...
      <div className="card">
        <h1 className="title">Hello Bonjour</h1>
      ...
      <Link to="/questions" className="quiz-btn"> Go to Quiz Questions</Link>
